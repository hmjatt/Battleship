      ...
      if (currentPlayer === "user") {
        ...
        computerSquares.forEach(function (square) {
          return square.addEventListener("click", function (e) {
            ...
            revealSquare(square.classList); // console.log(shotFired)
          });
        });
      }
