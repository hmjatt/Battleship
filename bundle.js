...
var gameLogic = {
  gameLogic: function gameLogic() {
    ...
    function dragDrop() {
      ...
      if (!displayGrid.querySelector(".ship")) allShipsPlaced = true; // if(allShipsPlaced == true) {
      // }
    }
